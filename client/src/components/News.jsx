...
export default function Gallery() {
  ...
  return (
    <div className="relative z-10 pt-20 4xl:pt-28">
      <div className="-mt-16 md:mt-0 bg-[#020911] sm:bg-transparent 2xl:bg-[#020911]">
        <div className="container sm:max-w-[834px] lg:max-w-[1380px] 3xl:max-w-[1690px] 5xl:max-w-[1550px] mx-auto relative">
          <div className="max-w-[88%] sm:max-w-[95%] 3xl:max-w-[90%] 5xl:max-w-[100%] mx-auto">
            <div className="2xl:bg-[#020911] flex flex-col md:flex-row justify-between items-center md:items-stretch pb-[20px] sm:pb-[60px] md:pb-[20px] xl:pb-[60px] 3xl:pb-[100px]">
              <div className="relative z-20 w-screen flex justify-center md:justify-stretch">
                <img
                  src={currentNewsImage}
                  className="rounded-[5px] md:rounded-[10px]  w-[320px] sm:w-[376px] md:w-[647px] 3xl:w-[750px] h-[289px] sm:h-[376px] md:h-[488px] xl:h-[655px] 3xl:h-[750px]  object-cover"
                  alt=""
                />
              </div>
              <div className="relative flex flex-col justify-between -mt-72 md:-mt-14 xl:mt-0">
                <div className="flex flex-col-reverse justify-between md:flex-col gap-8 md:gap-0">
                  <div className="flex flex-row-reverse pb-[5px] md:pb-[15px] z-20">
                    <div className="flex flex-row items-center w-[90px] sm:w-[120px] md:w-[170px] justify-between ">
                      ...
                      <div className="flex-auto text-lg md:text-3xl font-bold text-right text-white">
                  ...
                  <div className="flex justify-center md:absolute md:right-0">
                    <div className="flex flex-col mt-40 sm:mt-20 md:mt-40 xl:mt-48 3xl:mt-60 sm:w-[280px] md:w-[476px] xl:w-[763px] 3xl:w-[884px] z-20   bg-white rounded-[3px]">
                      <div
                ...
                <Link to={"/news/all"} className="flex -mt-8 md:mt-0 z-10">
                  <div className={`uppercase ${i18n.language === 'english' || i18n.language === 'korean' ? `text-base xl:text-lg` : ` text-xs xl:text-lg`}  font-bold text-left transition duration-300 hover:text-[#FFA801] cursor-pointer text-white`}>
                    {t('viewallnews')} &gt;
                  </div>
                </Link>                
              </div>
  ...
  <div className="bg-[#020911] w-screen absolute top-[450px] h-0 sm:h-80 md:h-40 xl:h-96 2xl:h-0"></div>
  </div>
  );
}
