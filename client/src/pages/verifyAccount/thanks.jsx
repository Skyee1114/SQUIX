    ...
    <div>
      ...
      <div className="container sm:max-w-[834px] lg:max-w-[1380px] 3xl:max-w-[1690px] 5xl:max-w-[1550px] mx-auto relative" >
        <div className="max-w-[88%] sm:max-w-[95%] 3xl:max-w-[90%] 5xl:max-w-[100%] mx-auto">  
          <div className="flex flex-col gap-8 pb-3 sm:pb-24 xl:pb-40 2xl:pb-48 pt-8 2xl:pt-16">
            ...
            <div className="flex flex-row mx-auto">
              <div className=" lg:w-[582px] 2xl:w-[708px] lg:h-[241px] 2xl:h-[501px] p-8 2xl:p-20 bg-white rounded-[3px] shadow flex-col justify-between items-start gap-4 lg:gap-0 inline-flex relative">
                ...
                <div className="w-full 2xl:w-[548px] h-16 p-5 bg-[#88A34F] bg-opacity-20 justify-start items-center gap-[18px] inline-flex">
